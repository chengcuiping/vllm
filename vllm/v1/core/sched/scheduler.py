...
class Scheduler(SchedulerInterface):
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        # Report the pre-pass slot preemption after the waiting loop so it
        # does not suppress same-step admission through the preempted_reqs gate.
        if slot_victim is not None:
            preempted_reqs.append(slot_victim)
